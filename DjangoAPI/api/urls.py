...
urlpatterns = [
    ...
    path("getassociatesedv/", GetAssociateAPIEDV.as_view(), name="getAssociatesedv"),
    path("getassociatesedv/<str:pk>/", GetAssociateAPIEDV.as_view(), name="getAssociatesedvParameters"),
    # path("getassociatesedv/<int:pkid>/", GetAssociateAPIEDV.as_view(), name="getAssociatesedvParameters"),
    ...
    path("getreleasemachinesanalise/<int:pk>/", GetReleaseMachineAnaliseAPI.as_view(), name="getreleasemachinesanalise"),
