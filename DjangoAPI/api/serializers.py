...
class GetAssociateTableEDV(serializers.ModelSerializer):
...
class ReleaseMachineTableAnalise(serializers.ModelSerializer):
    class Meta:
        many = True
        model = ReleaseMachine
        fields = ['idAssociateFK', 'InitialHour', 'date', 'description']
